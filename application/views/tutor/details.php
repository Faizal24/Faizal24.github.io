...
<div class="max1280 padding">
	<a class="btn float-right" href="tutor/dashboard/#requests" style="margin-top: 15px">Back</a>
	<h1 class="thin">Request Details</h1>
...
<div class="max1024 padding min-height-600">
	...
	<div class="tutor-request-action-box">
		<p class="align-center"><strong>Status: <span class="status"><?php echo $request->status; ?></span></strong></p>
				...
				<a href="tutor/accept_request/<?php echo $request->id; ?>" class="btn btn-block btn-primary align-center">Accept</a>
		...
		<ul class="list-action">
			...
			<?php else: ?>
				<li><i class="fa fa-lock"></i> <i class="fa fa-envelope"></i> Message client</li>
