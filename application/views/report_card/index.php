	...
	<?php foreach ($sessions as $session): ?>
		...
		<div class="job-request">
			<div class="job-request-action">
				...
				<div class="padding">
					<a href="report_card/assessment/<?php echo $session->session_id; ?>" class="btn btn-primary">View Assessment</a>					
				</div>
			</div>
			<div class="large-profile-photo" style="background-image: url('uploads/profile/<?php echo $user->photo; ?>')"></div>
			<h2>Assessment on <?php echo $request_data->student_name; ?>  <?php if (!$session->assessment_seen) echo '<span class="new">NEW</span>'; ?> </h2>
			<p>
				<?php echo $request_data->subject; ?> &mdash; <?php echo $request_data->grade; ?>
				<br /><small class="grey">TUTOR</small> <br /><?php echo $user->firstname; ?> <?php echo $user->lastname; ?>
