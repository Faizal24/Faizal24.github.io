!function(e) {
    ...
    return function e(t, n, r) {
            ...
            !function(e) {
                ...
                n.encode = function(t) {
                    ...
                    var u = new ArrayBuffer(s),
                        p = new Uint8Array(u);
                    for (n = 0; n < c; n += 4)
                        r = e.indexOf(t[n]), i = e.indexOf(t[n + 1]), o = e.indexOf(t[n + 2]), a = e.indexOf(t[n + 3]), p[d++] = r << 2 | i >> 4, p[d++] = (15 & i) << 4 | o >> 2, p[d++] = (3 & o) << 6 | 63 & a;
                    return u
                }
        ...
        10: [function(e, t, n) {
            ...
            t.exports = r, r.names = [], r.skips = [], r.enable = function(e) {
                ...
                for (var t = (e || "").split(/[\s,]+/), n = t.length, i = 0; i < n; i++)
                    e = t[i].replace("*", ".*?"), "-" === e[0] ? r.skips.push(new RegExp("^" + e.substr(1) + "$")) : r.names.push(new RegExp("^" + e + "$"))
            }, r.disable = function() {
                r.enable("")
            ...
            (function(n) {
                ...
                t.exports = r, r.priorWebsocketSuccess = !1, a(r.prototype), r.protocol = d.protocol, r.Socket = r, r.Transport = e("./transport"), r.transports = e("./transports"), r.parser = e("engine.io-parser"), r.prototype.createTransport = function(e) {
                        ...
                        p || (s('probe transport "%s" opened', e), u.send([{
                            ...
                            if (!p)
                                if ("pong" == t.type && "probe" == t.data) {
                                    if (s('probe transport "%s" pong', e), f.upgrading = !0, f.emit("upgrading", u), !u)
                                        return;
                    ...
                    if ("opening" == this.readyState || "open" == this.readyState)
                        switch (s('socket receive: type "%s", data "%s"', e.type, e.data), this.emit("packet", e), this.emit("heartbeat"), e.type) {
                        case "open":
        ...
        15: [function(e, t, n) {
            (function(t) {
                function r(e) {
                    ...
                    if (e.xdomain = r, e.xscheme = s, n = new i(e), "open" in n && !e.forceJSONP)
                        return new o(e);
                    if (!c)
            ...
            (function(n) {
                ...
                t.exports = i, t.exports.Request = o, u(i, c), i.prototype.supportsBinary = !0, i.prototype.request = function(e) {
                    ...
                    var t = this.xhr = new s(e),
                        r = this;
                    try {
                        if (p("xhr open %s: %s", this.method, this.uri), t.open(this.method, this.uri, this.async), this.supportsBinary && (t.responseType = "arraybuffer"), "POST" == this.method)
                            try {
                ...
                n.encodePacket = function(e, n, o, s) {
                    ...
                    for (var o, a, s = "", c = 0, d = e.length; c < d; c++) {
                        ...
                        if (":" != u)
                            ...
                            if ("" == s || s != (o = Number(s)))
                                return r(w, 0, 1);
                            if (a = e.substr(c + 1, o), s != a.length)
                                return r(w, 0, 1);
                            if (a.length) {
                                if (i = n.decodePacket(a, t, !0), w.type == i.type && w.data == i.data)
                                    return r(w, 0, 1);
                                var p = r(i, c + o, d);
                                if (!1 === p)
                                    return
        ...
        27: [function(e, t, n) {
            ...
            t.exports = function(e, t) {
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    ...
                    if (window.navigator.userAgent.match("Linux") && (c = 35), sessionStorage.getScreenMediaJSExtensionId)
                            ...
                            O = function(e, t, n, r, c, d, u) {
                                ...
                                if ("object" == typeof p && p)
                                    if (f = s.call(p), f != l || i.call(p, "toJSON"))
                                        "function" == typeof p.toJSON && (f != h && f != m && f != g || i.call(p, "toJSON")) && (p = p.toJSON(e));
                                    else if (p > -1 / 0 && p < 1 / 0) {
                                        if (C) {
                                            ...
                                            y = p.getUTCFullYear(), b = p.getUTCMonth(), S = p.getUTCDate(), T = p.getUTCHours(), E = p.getUTCMinutes(), R = p.getUTCSeconds(), D = p.getUTCMilliseconds();
                                        p = (y <= 0 || y >= 1e4 ? (y < 0 ? "-" : "+") + P(6, y < 0 ? -y : y) : P(4, y)) + "-" + P(2, b + 1) + "-" + P(2, S) + "T" + P(2, T) + ":" + P(2, E) + ":" + P(2, R) + "." + P(3, D) + "Z"
                                    } else
                                        p = null;
                                if (n && (p = n.call(t, e, p)), null === p)
                                    return "null";
                                if (f = s.call(p), f == v)
                                    return "" + p;
                                if (f == h)
                        ...
                        u.stringify = function(e, t, n) {
                            ...
                            if (n)
                                if ((a = s.call(n)) == h) {
                                    ...
                                    a == m && (r = n.length <= 10 ? n : n.slice(0, 10));
                        ...
                        var D,
                            ...
                            I = function() {
                                for (var e, t, n, r, i, o = j, a = o.length; D < a;)
                                    ...
                                    case 34:
                                        for (e = "@", D++; D < a;)
                                            if (i = o.charCodeAt(D), i < 32)
                                                ...
                                                case 117:
                                                    for (t = ++D, n = D + 4; D < n; D++)
                                                        i = o.charCodeAt(D), i >= 48 && i <= 57 || i >= 97 && i <= 102 || i >= 65 && i <= 70 || A();
                                                    e += M("0x" + o.slice(t, D));
                                                    break;
                                                default:
                                                    A()
                                    ...
                                    default:
                                        ...
                                        if (r && A(), "true" == o.slice(D, D + 4))
                                            return D += 4, !0;
                                        if ("false" == o.slice(D, D + 5))
                                            return D += 5, !1;
                                        if ("null" == o.slice(D, D + 4))
                                            return D += 4, null;
                                        A()
                                    }
                                return "$"
                            ...
                            L = function(e) {
                                ...
                                if ("$" == e && A(), "string" == typeof e) {
                                    ...
                                    if ("[" == e) {
                                        for (t = []; e = I(), "]" != e; n || (n = !0))
                                            n && ("," == e ? (e = I(), "]" == e && A()) : A()), "," == e && A(), t.push(L(e));
                                        return t
                                    }
                                    if ("{" == e) {
                                        for (t = {}; e = I(), "}" != e; n || (n = !0))
                                            n && ("," == e ? (e = I(), "}" == e && A()) : A()), "," != e && "string" == typeof e && "@" == (y ? e.charAt(0) : e[0]) && ":" == I() || A(), t[e.slice(1)] = L(I());
                                        return t
                                    }
                                    A()
                                }
        ...
        37: [function(e, t, n) {
            ...
            i.inherits(r, d), r.prototype.start = function(e, t) {
                ...
                s(r, function(e, i) {
                    if (e) {
                        if (n.config.audioFallback && "DevicesNotFoundError" === e.name && r.video !== !1)
                            return r.video = !1, void n.start(r, t)
                    } else
                        r.audio && n.config.detectSpeakingEvents && n.setupAudioMonitor(i, n.config.harkOptions), n.localStreams.push(i), n.config.autoAdjustMic && (n.gainController = new u(i), n.setMicIfEnabled(.5)), i.onended = function() {}, n.emit("localStream", i);
                    if (t)
                        return t(e, i)
                })
                ...
                if (e) {
                    ...
                    this.stopStreams(), this.stopScreenShare()
            ...
            (function(e) {
                ...
                function B(e, t) {
                    var n = $t(e) || ye(e) ? c(e.length, String) : [],
                        ...
                        i = !!r;
                    for (var o in e)
                        !t && !Ct.call(e, o) || i && ("length" == o || pe(o, r)) || n.push(o);
                    return n
                }
                function U(e, t, n) {
                    var r = e[t];
                ...
                function V(e, t, n, r, i, a, s) {
                    var c;
                    if (r && (c = a ? r(e, i, a, s) : r(e)), void 0 !== c)
                        return c;
                    if (!ke(e))
                        return e;
                    var d = $t(e);
                ...
                var dt = "object" == typeof e && e && e.Object === Object && e,
                    ...
                    Et = pt.Symbol,
                    Pt = pt.Uint8Array,
                    Rt = f(Object.getPrototypeOf, Object),
                    xt = Object.create,
        ...
        41: [function(e, t, n) {
            for (var r = "assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(","), i = r.length, o = function() {}, a = {}; i--;)
                a[r[i]] = o;
            t.exports = a
        }, {}],
        42: [function(e, t, n) {
                    ...
                    t = function(t, n) {
                        if (t = JSON.parse(JSON.stringify(t)), t && t.audio && (t.audio = e(t.audio)), t && "object" == typeof t.video) {
                            ...
                            if (i = i && ("object" == typeof i ? i : {
                                ideal: i
                            }), i && ("user" === i.exact || "environment" === i.exact || "user" === i.ideal || "environment" === i.ideal) && (!navigator.mediaDevices.getSupportedConstraints || !navigator.mediaDevices.getSupportedConstraints().facingMode) && (delete t.video.facingMode, "environment" === i.exact || "environment" === i.ideal))
                    ...
                    shimPeerConnection: function() {
                        window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function(e) {
                            ...
                            switch (this.usingBundle = r.matchPrefix(a, "a=group:BUNDLE ").length > 0, o.forEach(function(o, c) {
                                ...
                                if (h = h.length ? h[0].substr(6) : r.generateIdentifier(), "application" === p && "DTLS/SCTP" === u[2])
        ...
        57: [function(e, t, n) {
            ...
            i.inherits(r, a), Object.defineProperty(r.prototype, "signalingState", {
                ...
                if (e.contents || e.jingle && e.jingle.contents) {
                    ...
                    if (e.candidate && 0 !== e.candidate.candidate.indexOf("a=") && (e.candidate.candidate = "a=" + e.candidate.candidate), this.wtFirefox && null !== this.firefoxcandidatebuffer && this.pc.localDescription && "offer" === this.pc.localDescription.type)
                ...
                if (e.candidate) {
                    ...
                    var i,
                        a,
                        s = o.toCandidateJSON(n.candidate);
                    ...
                    }), a = i.indexOf(s.foundation + ":" + s.component), a > -1 && s.priority >> 24 >= i[a].priority >> 24))
                        return;
                    ...
                    }), a = i.indexOf(s.address + ":" + s.port), a > -1))
                        return;
        ...
        59: [function(e, t, n) {
            n.lines = function(e) {
                ...
                for (var t, n, r, i = e.substr(e.indexOf(" ") + 1).split(";"), o = [], a = 0; a < i.length; a++)
                    t = i[a].split("="), n = t[0].trim(), r = t[1], n && r ? o.push({
                        key: n,
                        value: r
                    }) : n && o.push({
                        key: "",
        ...
        61: [function(e, t, n) {
            ...
            n._setIdCounter = function(e) {
                ...
                for (r = 1; r < c.length; r++)
                    c[r] = "m=" + c[r], r !== c.length - 1 && (c[r] += "\r\n");
                var d = c.shift() + "\r\n",
                    u = i.lines(d),
                    p = {},
                    f = [];
                for (r = 0; r < c.length; r++)
                    f.push(n.toMediaJSON(c[r], d, {
                        role: a,
                        direction: s,
                ...
                var R = i.findLines("a=fingerprint:", d, u),
                    x = i.findLine("a=setup:", d, u);
                R.forEach(function(e) {
        ...
        71: [function(e, t, n) {
            ...
            n.protocol = 4, n.types = ["CONNECT", "DISCONNECT", "EVENT", "BINARY_EVENT", "ACK", "BINARY_ACK", "ERROR"], n.CONNECT = 0, n.DISCONNECT = 1, n.EVENT = 2, n.ACK = 3, n.ERROR = 4, n.BINARY_EVENT = 5, n.BINARY_ACK = 6, n.Encoder = r, n.Decoder = a, r.prototype.encode = function(e, t) {
                if (u("encoding packet %j", e), n.BINARY_EVENT == e.type || n.BINARY_ACK == e.type)
                    o(e, t);
                else {
                    var r = i(e);
                    t([r])
                ...
                var t;
                if ("string" == typeof e)
                    t = s(e), n.BINARY_EVENT == t.type || n.BINARY_ACK == t.type ? (this.reconstructor = new c(t), 0 === this.reconstructor.reconPack.attachments && this.emit("decoded", t)) : this.emit("decoded", t);
                else {
                    if (!h(e) && !e.base64)
                ...
                !function(i) {
                    ...
                    function a(e) {
                        for (var t, n = e.length, r = -1, i = ""; ++r < n;)
                            t = e[r], t > 65535 && (t -= 65536, i += b(t >>> 10 & 1023 | 55296), t = 56320 | 1023 & t), i += b(t);
                        return i
                    }
                    function s(e) {
                        if (e >= 55296 && e <= 57343)
                    ...
                    function f() {
                        ...
                        if (224 == (240 & e)) {
                            if (t = p(), n = p(), i = (15 & e) << 12 | t << 6 | n, i >= 2048)
                                return s(i), i;
                            throw Error("Invalid continuation byte")
                        }
                        if (240 == (248 & e) && (t = p(), n = p(), r = p(), i = (15 & e) << 18 | t << 12 | n << 6 | r, i >= 65536 && i <= 1114111))
                            return i;
        ...
        78: [function(e, t, n) {
            (function(t, r) {
                ...
                function c(e, t, r) {
                    ...
                    var a = Object.keys(t),
                        m = s(a);
                    if (e.showHidden && (a = Object.getOwnPropertyNames(t)), E(t) && (a.indexOf("message") >= 0 || a.indexOf("description") >= 0))
                        return u(t);
                    if (0 === a.length) {
                        if (P(t)) {
                            var g = t.name ? ": " + t.name : "";
                    ...
                    if (S(t) && (v = " " + RegExp.prototype.toString.call(t)), T(t) && (v = " " + Date.prototype.toUTCString.call(t)), E(t) && (v = " " + u(t)), 0 === a.length && (!y || 0 == t.length))
                        return b[0] + v + b[1];
                    if (r < 0)
                    ...
                    shimPeerConnection: function() {
                        window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function(e) {
                            ...
                            switch (this.usingBundle = r.matchPrefix(a, "a=group:BUNDLE ").length > 0, o.forEach(function(o, c) {
                                ...
                                if ("offer" !== e.type || T)
                                    "answer" !== e.type || T || (d = t.transceivers[c], u = d.iceGatherer, p = d.iceTransport, f = d.dtlsTransport, l = d.rtpSender, h = d.rtpReceiver, m = d.sendEncodingParameters, v = d.localCapabilities, t.transceivers[c].recvEncodingParameters = g, t.transceivers[c].remoteCapabilities = P, t.transceivers[c].cname = x, (s || D) && j.length && p.setRemoteCandidates(j), t.usingBundle && 0 !== c || (p.start(u, w, "controlling"), f.start(b)), t._transceive(d, "sendrecv" === E || "recvonly" === E, "sendrecv" === E || "sendonly" === E), !h || "sendrecv" !== E && "sendonly" !== E ? delete d.rtpReceiver : (y = h.track, i.push([y, h]), n.addTrack(y)));
                                else {
                                    var M = t.usingBundle && c > 0 ? {
                                        iceGatherer: t.transceivers[0].iceGatherer,
                                        iceTransport: t.transceivers[0].iceTransport,
        ...
        87: [function(e, t, n) {
            ...
            var r = !0,
                i = {
                    ...
                    detectBrowser: function() {
                        var e = {};
                        if (e.browser = null, e.version = null, e.minVersion = null, "undefined" == typeof window || !window.navigator)
                            return e.browser = "Not a browser.", e;
                        if (navigator.mozGetUserMedia)
                            e.browser = "firefox", e.version = this.extractVersion(navigator.userAgent, /Firefox\/([0-9]+)\./, 1), e.minVersion = 31;
                        else if (navigator.webkitGetUserMedia)
                            if (window.webkitRTCPeerConnection)
                                e.browser = "chrome", e.version = this.extractVersion(navigator.userAgent, /Chrom(e|ium)\/([0-9]+)\./, 2), e.minVersion = 38;
                            else {
                                if (!navigator.userAgent.match(/Version\/(\d+).(\d+)/))
                                    return e.browser = "Unsupported webkit-based browser with GUM support but no WebRTC support.", e;
        ...
        89: [function(e, t, n) {
            ...
            t.exports = r, r.mixin = function(e) {
                ...
                t.isWildEmitter = !0, t.on = function(e, t, n) {
                    ...
                    if (o)
                        for (r = o.slice(), t = 0, n = r.length; t < n && r[t]; ++t)
                            r[t].apply(this, i);
                    if (a)
        ...
        91: [function(e, t, n) {
            ...
            o.inherits(i, c), i.prototype.handleMessage = function(e) {
                var t = this;
                if (this.logger.log("getting", e.type, e), e.prefix && (this.browserPrefix = e.prefix), "offer" === e.type)
                    this.nick || (this.nick = e.payload.nick), delete e.payload.nick, this.pc.handleOffer(e.payload, function(e) {
                        e || t.pc.answer(function(e, t) {})
                    });
                else if ("answer" === e.type)
                    this.nick || (this.nick = e.payload.nick), delete e.payload.nick, this.pc.handleAnswer(e.payload);
        ...
        92: [function(e, t, n) {
            function r(e) {
                ...
                for (t in u)
                    u.hasOwnProperty(t) && (this.config[t] = u[t]);
                this.capabilities = a, o.call(this), n = null === this.config.connection ? this.connection = new d(this.config) : this.connection = this.config.connection, n.on("connect", function() {
                    ...
                    var t,
                        n = r.webrtc.getPeers(e.from, e.roomType);
        ...
        94: [function(e, t, n) {
            function r(e) {
                ...
                for (t in r)
                    r.hasOwnProperty(t) && (this.config[t] = r[t]);
